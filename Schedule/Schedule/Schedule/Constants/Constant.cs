    ...
    public static class Constant
    {
        ...
        public static IEnumerable<ExerciseType> DefaultTypes
        {
            get
            {
                ...
                {
                    new ExerciseType(){Type = ExerciseTypeEnum.Груди ,TypeName = Enums.ExerciseTypeEnum.Груди.ToString(), TypeColor = Color.FromHex("a3a948"),
                        ImagePath = "@drawable/chest.png"},
                    new ExerciseType(){Type = ExerciseTypeEnum.Біцепс, TypeName = Enums.ExerciseTypeEnum.Біцепс.ToString(), TypeColor = Color.FromHex("EDB92E"),
                    ...
                    new ExerciseType(){Type = ExerciseTypeEnum.Трицепс, TypeName = Enums.ExerciseTypeEnum.Трицепс.ToString(), TypeColor = Color.FromHex("973d97"),
                    ...
                    new ExerciseType(){Type = ExerciseTypeEnum.Кардіо, TypeName = Enums.ExerciseTypeEnum.Кардіо.ToString(), TypeColor = Color.FromHex("3d973d"),
        ...
        public static IEnumerable<Exercise> DefaultExercises
        {
            get
            {
                ...
                {
                    new Exercise (){ Name = "Жим штанги лежачи", Type = ExerciseTypeEnum.Груди.ToString(),  Color = Color.Purple},
